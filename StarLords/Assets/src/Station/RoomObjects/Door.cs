...
public class Door : Room_Object  {
	...
	public override void Setup(float globX, float globY, Quaternion rotation, Rectangle rect_Dimension)
	{
		...
		//Grab the Room
		model_Object  = Resources.Load<GameObject>("GameObjects/Room_Objects/Room_Door");
		...
		model_Object.transform.Find("Cube_001").renderer.material = (mat_Object);
